...
@interface RegisterInfoViewController ()<WKNavigationDelegate, WKUIDelegate>
...
- (void)loadExamplePage:(WKWebView*)webView {
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@", UserRegisterInfo_URL, GetUuid]]]];
