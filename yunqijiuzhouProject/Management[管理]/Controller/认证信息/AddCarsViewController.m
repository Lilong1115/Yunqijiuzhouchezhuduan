...
@interface AddCarsViewController ()<WKNavigationDelegate, WKUIDelegate>
...
- (void)setUpWKWebView {
    ...
    [self loadExamplePage:self.wkWebView URLStr:AddCar_URL];
}
...
- (void)loadExamplePage:(WKWebView*)webView URLStr:(NSString *)urlStr {
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@", urlStr, GetUuid]]]];
