//
//  FreightRevenueViewController.m
//  yunqijiuzhouProject
//
...
#import "FreightRevenueViewController.h"
#import "UserInfo.h"
#import "CallPhone.h"
#import "ShippingDetailsViewController.h"

@interface FreightRevenueViewController ()<WKNavigationDelegate, WKUIDelegate>
...
@implementation FreightRevenueViewController
...
- (void)setUpWKWebView {
    ...
    //详情
    [_bridge registerHandler:@"detail" handler:^(id data, WVJBResponseCallback responseCallback) {
        NSString *str = (NSString *)data;
        
        ShippingDetailsViewController *vc = [[ShippingDetailsViewController alloc]init];
        vc.urlStr = str;
...
- (void)loadExamplePage:(WKWebView*)webView {
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@", FreightRevenue_URL, GetUuid]]]];
