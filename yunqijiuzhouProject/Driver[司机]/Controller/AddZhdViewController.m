...
@interface AddZhdViewController ()<WKNavigationDelegate, WKUIDelegate>
...
@implementation AddZhdViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    
    self.navigationItem.title = @"装货单";
